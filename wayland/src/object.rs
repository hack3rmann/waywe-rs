...
impl WlObjectType {
    ...
    pub const fn interface(self) -> &'static Interface<'static> {
        match self {
            Self::Display => &protocol::wl_display::INTERFACE,
            Self::Surface => &protocol::wl_surface::INTERFACE,
            Self::Region => &protocol::wl_region::INTERFACE,
            Self::Callback => &protocol::wl_callback::INTERFACE,
            Self::Registry => &protocol::wl_registry::INTERFACE,
            Self::ShmPool => &protocol::wl_shm_pool::INTERFACE,
            Self::Compositor => &protocol::wl_compositor::INTERFACE,
            Self::Shm => &protocol::wl_shm::INTERFACE,
            Self::Buffer => &protocol::wl_buffer::INTERFACE,
            Self::Output => &protocol::wl_output::INTERFACE,
            Self::LayerShell => &protocol::zwlr_layer_shell_v1::INTERFACE,
    ...
    pub const fn backend_interface(self) -> &'static wl_interface {
        match self {
            Self::Display => &protocol::wl_display::WL_INTERFACE,
            Self::Surface => &protocol::wl_surface::WL_INTERFACE,
            Self::Region => &protocol::wl_region::WL_INTERFACE,
            Self::Callback => &protocol::wl_callback::WL_INTERFACE,
            Self::Registry => &protocol::wl_registry::WL_INTERFACE,
            Self::ShmPool => &protocol::wl_shm_pool::WL_INTERFACE,
            Self::Compositor => &protocol::wl_compositor::WL_INTERFACE,
            Self::Shm => &protocol::wl_shm::WL_INTERFACE,
            Self::Buffer => &protocol::wl_buffer::WL_INTERFACE,
            Self::Output => &protocol::wl_output::WL_INTERFACE,
            Self::LayerShell => &protocol::zwlr_layer_shell_v1::WL_INTERFACE,
