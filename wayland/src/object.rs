...
impl WlObjectType {
    ...
    pub const fn interface(self) -> &'static Interface<'static> {
        match self {
            Self::Display => &crate::sys::protocols::wl_display::INTERFACE,
            Self::Surface => &crate::sys::protocols::wl_surface::INTERFACE,
            Self::Region => &crate::sys::protocols::wl_region::INTERFACE,
            Self::Callback => &crate::sys::protocols::wl_callback::INTERFACE,
            Self::Registry => &crate::sys::protocols::wl_registry::INTERFACE,
            Self::ShmPool => &crate::sys::protocols::wl_shm_pool::INTERFACE,
            Self::Compositor => &crate::sys::protocols::wl_compositor::INTERFACE,
            Self::Shm => &crate::sys::protocols::wl_shm::INTERFACE,
            Self::Buffer => &crate::sys::protocols::wl_buffer::INTERFACE,
            Self::Output => &crate::sys::protocols::wl_output::INTERFACE,
            Self::WlrLayerShellV1 => &crate::sys::protocols::zwlr_layer_shell_v1::INTERFACE,
            Self::WlrLayerSurfaceV1 => &crate::sys::protocols::zwlr_layer_surface_v1::INTERFACE,
            Self::Viewporter => &crate::sys::protocols::wp_viewporter::INTERFACE,
            Self::Viewport => &crate::sys::protocols::wp_viewport::INTERFACE,
        }
    }
    ...
    pub const fn backend_interface(self) -> &'static wl_interface {
        match self {
            Self::Display => &crate::sys::protocols::wl_display::WL_INTERFACE,
            Self::Surface => &crate::sys::protocols::wl_surface::WL_INTERFACE,
            Self::Region => &crate::sys::protocols::wl_region::WL_INTERFACE,
            Self::Callback => &crate::sys::protocols::wl_callback::WL_INTERFACE,
            Self::Registry => &crate::sys::protocols::wl_registry::WL_INTERFACE,
            Self::ShmPool => &crate::sys::protocols::wl_shm_pool::WL_INTERFACE,
            Self::Compositor => &crate::sys::protocols::wl_compositor::WL_INTERFACE,
            Self::Shm => &crate::sys::protocols::wl_shm::WL_INTERFACE,
            Self::Buffer => &crate::sys::protocols::wl_buffer::WL_INTERFACE,
            Self::Output => &crate::sys::protocols::wl_output::WL_INTERFACE,
            Self::WlrLayerShellV1 => &crate::sys::protocols::zwlr_layer_shell_v1::WL_INTERFACE,
            Self::WlrLayerSurfaceV1 => &crate::sys::protocols::zwlr_layer_surface_v1::WL_INTERFACE,
            Self::Viewporter => &crate::sys::protocols::wp_viewporter::WL_INTERFACE,
            Self::Viewport => &crate::sys::protocols::wp_viewport::WL_INTERFACE,
        }
    }
