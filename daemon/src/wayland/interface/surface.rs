...
use crate::wayland::object::ObjectId;
use crate::wayland::wire::Message;
use crate::wayland::wire::MessageBuffer;
use crate::wayland::wire::MessageBuildError;
use crate::wayland::wire::MessageHeaderDesc;

pub mod request {
    use super::*;
    use crate::wayland::interface::Request;
...
pub mod event {
    use super::*;
    use crate::wayland::interface::Event;
