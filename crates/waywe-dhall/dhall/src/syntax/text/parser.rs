...
use crate::syntax::{
    ...
    InterpolatedTextContents, Label, NaiveDouble, Natural, Scheme, Span, UnspannedExpr, URL, V,
};
...
impl DhallParser {
    ...
    fn posix_environment_variable_character(input: ParseInput) -> ParseResult<&str> {
        Ok(match input.as_str() {
            "\\\"" => "\"",
            "\\\\" => "\\",
            "\\a" => "\u{0007}",
