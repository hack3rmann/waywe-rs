mod serde {
    ...
    where
        T: ToDhall + FromDhall + StaticType + PartialEq + std::fmt::Debug + Clone,
    {
        assert_de(s, x.clone());
        assert_ser(s, x);
    }
    ...
    fn tuple() {
        assert_serde::<()>(r#"{=}"#, ());
        assert_serde::<(u64, String)>(r#"{ _1 = 1, _2 = "foo" }"#, (1, "foo".to_owned()));
        assert_serde::<(u64, u64, u64, u64)>(r#"{ _1 = 1, _2 = 2, _3 = 3, _4 = 4 }"#, (1, 2, 3, 4));
    }
    ...
    fn structs() {
        ...
        #[derive(Debug, Clone, PartialEq, Eq, Deserialize, Serialize, StaticType)]
        struct Baz {
            x: u64,
            y: i64,
        }
    ...
    fn test_file() {
        assert_eq!(
            serde_dhall::from_file("../dhall-lang/tests/parser/success/unit/BoolLitTrueA.dhall")
                .static_type_annotation()
                .parse::<bool>()
                .map_err(|e| e.to_string()),
            Ok(true)
    ...
    fn test_prelude() {
        assert_eq!(
            serde_dhall::from_str("https://prelude.dhall-lang.org/package.dhall")
                .parse::<Value>()
                .map(|_| ())
                .map_err(|e| e.to_string()),
            Ok(())
