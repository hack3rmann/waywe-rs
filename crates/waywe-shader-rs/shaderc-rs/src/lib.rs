...
impl<'a> CompileOptions<'a> {
        ...
        F: Fn(&str, IncludeType, &str, usize) -> IncludeCallbackResult + 'a,
    {
        ...
        unsafe extern "C" fn resolver<'a, F>(
                ...
                match f(&requested_source, type_, &requesting_source, include_depth) {
                    Ok(ResolvedInclude {
                        ...
                        if resolved_name.is_empty() {
                            panic!(
                                "include callback: empty strings for resolved include names not allowed"
                            );
                        }
        ...
        unsafe extern "C" fn releaser(
            _: *mut c_void,
            include_result: *mut scs::shaderc_include_result,
        ) {
